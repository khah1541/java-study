...
//크리처 클래스는 시리얼인터페이스를 구현하며 디폴트 id를 만들었음
class Creature implements Serializable{
	private static final long serialVersionUID = 1L;
	
	
}
//Cat 클래스는 크리쳐클래스를 상속해서 디폴트 id 생성했음
...
public class App {
	...
	public static void main(String[] args) {
		...
		System.out.println(c1 instanceof Serializable); //Serizlizable 인터페이스 구현했기 때문에 true
		
		System.out.println(c1 instanceof Creature );// 크리쳐 클래스의 객체임
